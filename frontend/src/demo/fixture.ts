...
export const DEMO_SENTENCES: DemoSentence[] = [
  {
    presentation: {
      ...
      render_segments: [
        { text: 'なんとなく', sentence_item_id: 1101 },
        { text: '気が乗らなくて', sentence_item_id: 1102 },
        { text: '、今日は家にいた。', sentence_item_id: null },
      ],
  ...
  },
  {
    presentation: {
      ...
      render_segments: [
        { text: '明日は早く', sentence_item_id: null },
        { text: '起きるつもりだった', sentence_item_id: 1201 },
        { text: 'のに、また', sentence_item_id: null },
        { text: '夜更かし', sentence_item_id: 1202 },
        { text: 'してしまった。', sentence_item_id: null },
      ],
  ...
  },
  {
    presentation: {
      ...
      render_segments: [
        { text: '誘われたけど、なんだか', sentence_item_id: null },
        { text: '気が乗らない', sentence_item_id: 1301 },
        { text: 'ので断った。', sentence_item_id: null },
      ],
      presentation_role: 'review',
